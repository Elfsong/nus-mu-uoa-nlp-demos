...
class MultilingualQAModel(object):
    ...
    def set_corpus(self):
        ...
        self.corpus["EN"] = dict()
        docs, vectors = self.get_corpus("./app/multilingual_qa/static/data/EnglishDocuments.json", "EN")
        self.corpus["EN"]["docs"] = docs
        self.corpus["EN"]["vectors"] = vectors

        print("[+] Loding [MS] corpus...")
        self.corpus["MS"] = dict()
        docs, vectors = self.get_corpus("./app/multilingual_qa/static/data/MalayDocuments.json", "MS")
        self.corpus["MS"]["docs"] = docs
        self.corpus["MS"]["vectors"] = vectors

        print("[+] Loding [TH] corpus...")
        self.corpus["TH"] = dict()
        docs, vectors = self.get_corpus("./app/multilingual_qa/static/data/ThaiDocuments.json", "TH")
